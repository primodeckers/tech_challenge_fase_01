...
**Infra:** estabilidade do `/health`, contagem de 5xx no `/predict`, latência em p50 e p95. O middleware já escreve `latency_ms` em JSON no stdout; num datacenter isso ia para uma ferramenta tipo Prometheus ou Grafana, não para o terminal do colega.
